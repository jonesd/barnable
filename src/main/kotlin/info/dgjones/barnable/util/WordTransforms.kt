...
fun transformCamelCaseToSpaceSeparatedWords(camelCase: String): String =
    transformCamelCaseToSeparatedWords(camelCase, " ")

fun transformCamelCaseToHyphenSeparatedWords(camelCase: String): String =
    transformCamelCaseToSeparatedWords(camelCase, "-")
